...
import com.adapp.repository.TagRepository;
...
class TagResourceIT {
    ...
    public static Tag createEntity(EntityManager em) {
        Tag tag = new Tag().tekst(DEFAULT_TEKST);
        return tag;
    }
    ...
    public static Tag createUpdatedEntity(EntityManager em) {
        Tag tag = new Tag().tekst(UPDATED_TEKST);
        return tag;
    }
    ...
    void createTag() throws Exception {
        ...
        assertThat(testTag.getTekst()).isEqualTo(DEFAULT_TEKST);
    }
    ...
    void putExistingTag() throws Exception {
        ...
        updatedTag.tekst(UPDATED_TEKST);
        ...
        Tag testTag = tagList.get(tagList.size() - 1);
        assertThat(testTag.getTekst()).isEqualTo(UPDATED_TEKST);
    }
    ...
    void partialUpdateTagWithPatch() throws Exception {
        ...
        partialUpdatedTag.tekst(UPDATED_TEKST);
