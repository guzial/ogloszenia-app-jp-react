...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './wystawca.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WYSTAWCA_LIST actions', async () => {
    ...
    it('dispatches FETCH_WYSTAWCA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WYSTAWCA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WYSTAWCA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WYSTAWCA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WYSTAWCA actions', async () => {
      const expectedActions = [
        {
