...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OGLOSZENIE_LIST actions', async () => {
    ...
    it('dispatches FETCH_OGLOSZENIE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_OGLOSZENIE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_OGLOSZENIE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_OGLOSZENIE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_OGLOSZENIE actions', async () => {
      const expectedActions = [
        {
