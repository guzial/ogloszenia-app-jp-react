...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GRUPATAGOW_LIST actions', async () => {
    ...
    it('dispatches FETCH_GRUPATAGOW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GRUPATAGOW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GRUPATAGOW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GRUPATAGOW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GRUPATAGOW actions', async () => {
      const expectedActions = [
        {
