...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './typ-umowy.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TYPUMOWY_LIST actions', async () => {
    ...
    it('dispatches FETCH_TYPUMOWY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TYPUMOWY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TYPUMOWY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TYPUMOWY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TYPUMOWY actions', async () => {
      const expectedActions = [
        {
