...
export const SeniorityDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="ogloszeniaAppReactApp.seniority.delete.question">
        <Translate contentKey="ogloszeniaAppReactApp.seniority.delete.question" interpolate={{ id: seniorityEntity.id }}>
