...
import { ISeniority, defaultValue } from 'app/shared/model/seniority.model';
...
const apiUrl = 'api/seniorities';

// Actions

export const getEntities = createAsyncThunk('seniority/fetch_entity_list', async ({ sort }: IQueryParams) => {
